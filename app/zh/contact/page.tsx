        ...
        <div className="container-shell grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="space-y-8">
            <div className="card-surface bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(244,235,215,0.42))] p-7">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate">{contactZh.directContact}</p>
            ...
            <div className="card-surface p-7">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate">{contactZh.typicalDiscussions}</p>
